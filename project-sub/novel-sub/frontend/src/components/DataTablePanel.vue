<template>
  <div
    ref="panelRef"
    class="novel-data-table-panel"
    :style="panelStyle"
  >
    <div
      class="novel-data-table-panel__body"
      :style="bodyStyle"
    >
      <slot
    ...
    <div
      v-if="showFooter"
      ref="footerRef"
      class="novel-data-table-panel__footer"
      :style="footerStyle"
    >
      <el-pagination
        :current-page="page"
...
<style scoped>
.novel-data-table-panel {
  position: relative;
  width: 100%;
}

.novel-data-table-panel__body {
  overflow: hidden;
}

.novel-data-table-panel__footer {
  display: flex;
