...
INSERT INTO test_scheme_enum (scheme_id, name, description, sort_order) VALUES ('TS-05-API', '前置链路+接口模板', 'preflight + ft_api_template + poll/语义比对（api_ctx）', 11) ON CONFLICT (scheme_id) DO NOTHING;
