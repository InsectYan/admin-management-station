-- 子类默认 TS/VS 映射表 + 大类默认验证标准

ALTER TABLE test_category_major ADD COLUMN IF NOT EXISTS default_validation_id VARCHAR(20) REFERENCES test_validation_enum(validation_id);
