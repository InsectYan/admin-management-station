...
const NEW_ITEMS = [
  ...
  // ── A3 HTTP/服务（测试金字塔，关联 D 维度已有接口项）──
  {
    ...
    automation_entry_id: "AUTO_E2E", automation_command: "cd server && npm run test:e2e -- smoke",
  ...
  },
  {
    ...
    automation_command: "cd server && npm run test:e2e -- smoke", automation_entry_id: "AUTO_E2E",
  ...
  },
  {
    ...
    automation_entry_id: "AUTO_E2E", automation_command: "cd server && npm run test:e2e -- chain",
  ...
  },
  {
    ...
    automation_status_id: "AUTO_EXISTING", automation_entry_id: "AUTO_E2E",
  ...
  },
  {
    ...
    priority_id: "P1", automation_status_id: "AUTO_EXISTING", automation_entry_id: "AUTO_E2E",
