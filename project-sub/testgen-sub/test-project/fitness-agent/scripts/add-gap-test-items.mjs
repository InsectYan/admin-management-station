...
const NEW_ITEMS = [
  ...
  },
  {
    ...
    preconditions: ["turn 已 submit"], test_steps: ["SSE 断开后 GET /api/chat/turns/:id 轮询", "断言终态 status + message"],
    assertion_points: ["poll 返回终态"], priority_id: "P1", prd_ref_ids: ["PRD_2"],
    arch_ref_ids: ["ARCH_B6"], prd_goal_ids: [], automation_status_id: "AUTO_EXISTING",
    automation_entry_id: "AUTO_S06", automation_command: "cd server && npm run test:stations -- turns-poll",
    station_id: "S06", role_scope_id: "ALL", endpoint_path: "/api/chat/turns/:id", http_method: "GET",
    http_status_expected: 200, scheme_primary_id: "TS-01-DET", validation_primary_id: "VS-01-EXACT",
    sample_execution_note: "poll 兜底路径", scheme_mapping_source: "scheme-map.json",
    tags: ["A3", "D1"], source_doc: "A-测试层级.md", source_section: "A3", is_active: true,
    exec_env_id: "EXEC_BOTH", env_tier_id: "TIER_ANY", project_code: "fitness-agent",
    project_name: "Fitness Agent 测试项目", test_input_example: null, prd_ref_id: null, arch_ref_id: null,
    config_env: null, config_env_id: null, scheme_secondary_id: null, validation_secondary_id: null,
    is_risk_flag: false, is_observability_audit: false, is_p0_blocker: false, failure_symptom: null,
    code_reference: "server/src/stations/s03-queue/tests/turns-router-poll.test.ts", notes: null,
