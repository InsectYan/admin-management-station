# Fitness 测试体系 — Agent 协作设计

> **版本**：v0.2 · 2026-06-30  
> **背景**：执行引擎 E1~E5（TS-01~TS-08 + VS-01~VS-09）已落地；本文定义 testgen-sub 全链路 Agent 能力、嵌入方式与协作关系。  
> **关联**：[待办-开发节点追踪.md](./待办-开发节点追踪.md) · [待办-Agent开发任务清单.md](./待办-Agent开发任务清单.md) · [README.md](./README.md)
...
> 逐项任务与完成状态见 [待办-Agent开发任务清单.md](./待办-Agent开发任务清单.md)
...
*执行引擎进度以 [待办-开发节点追踪.md](./待办-开发节点追踪.md) 为准；Agent 以 agent-management-sub PR + 本文 §7 验收为准。*
