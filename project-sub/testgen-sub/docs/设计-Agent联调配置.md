...
> Agent 插件目录：`agent-management-master/plugins/`（源码在 `agent-management-sub/plugins/`）  
...
*详见 [待办-Agent开发任务清单.md](./待办-Agent开发任务清单.md) · [设计-Agent协作与Skill嵌入.md](./设计-Agent协作与Skill嵌入.md)*
